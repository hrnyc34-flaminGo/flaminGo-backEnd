...
router.get('/tasks', controller.rooms.get);
router.post('/tasks', controller.rooms.post);
router.put('/tasks', controller.rooms.put);
router.put('/tasks/:roomId', controller.tasks.put);
router.delete('/tasks', controller.rooms.delete);
